...
import logoMlb from '@/images/logos/mlb.svg'
import logoMlb2 from '@/images/logos/mlb2.svg'
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/Ben_Ricker_Resume.pdf" variant="secondary" className="group mt-6 w-full">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software Engineer, Managing Leader, Culture Fanatic, and Guy Who&apos;s Happy You&apos;re Here®
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/bgricker"
              aria-label="GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/benrickeronline/"
              aria-label="LinkedIn"
              icon={LinkedInIcon}
            />
            <SocialLink
              href="https://www.instagram.com/sketchharvey/"
